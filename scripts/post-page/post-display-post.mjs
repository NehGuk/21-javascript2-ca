    ...
    <div class="row row-cols-1 row-cols-md-1 g-4 posts-container">
        ...
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="/user.html?${post.author.name}"><img src="${post.author.avatar}" width="32" height="32" class="rounded-circle border border-primary" style="width: 32; height: 32; object-fit: cover; border-width: 1px !important; alt="${post.author.name} avatar"></a>
                <small class="text-muted"><a href="/user.html?${post.author.name}" style="text-decoration: none"><strong>${post.author.name}</strong></a>&emsp;</small>
